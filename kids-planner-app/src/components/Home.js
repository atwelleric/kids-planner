...
// Hou comment: nice job integration font-awesome into your app!
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faHome } from '@fortawesome/free-solid-svg-icons';
import { faSun } from '@fortawesome/free-solid-svg-icons';
import { faClipboardList } from '@fortawesome/free-solid-svg-icons';

// Hou comment: nice job with using functional components throughout your codebase!
function Home() {
	return (
		<div className='temp'>
			...
			<h2 className='home-page-header'>
				Click the{' '}
				<span className='home-span'>
					Clipboard <FontAwesomeIcon icon={faClipboardList} /> 
				</span> at the top of the screen to set some reminders on things you have to do today.
			...
			<h2 className='home-page-header'>
				...
				</span> and it'll bring you right back here.
